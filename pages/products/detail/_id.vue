      ...
      <div class="c-row" v-if="pr.images != undefined">
          ...
          <div class="thumb">
            ...
            >
              <div
                v-for="(img, index) in pr.images"
                :key="index"
                class="slide rounded-md pl-4"
                @mousemove="$refs.main.goTo(index)"
              >
        ...
        <div class="right-col">
          ...
          <div class="flex w-full justify-between items-center mb-5">
            <div class="price text-2xl font-bold text-black">
              {{ pr.price }} TMT
            </div>

            <div class="counter">
              <div
                class="c-button border-2 border-blue-700 px-[12px] rounded-md transition-colors duration-200 hover:border-blue-700 hover:text-white hover:bg-blue-700"
                @click="minus"
              >
                -
              </div>
              ...
              <div
                type="text"
                name="count"
                class="border-y-2 border-blue-700 w-10 font-bold text-center"
              >
                {{ pr.amount }}
              </div>
              <div
                class="c-button border-2 border-blue-700 px-2 rounded-md transition-colors duration-200 hover:border-blue-700 hover:text-white hover:bg-blue-700"
                @click="plus"
              >
                +
              </div>
          ...
          <div class="sizes">
            <ul>
              ...
              >
                <div
                  class="item hover:bg-blue-400 p-2 whitespace-nowrap hover:text-white transition-colors duration-200 rounded-sm"
          ...
          <div class="action-bar">
            <button
              class="add-to-cart transition-colors duration-200 hover:border-2 border-2 rounded-xl"
              @click="addToCart()"
            >
              <BIconCart />
              {{ $tr.t("sebede goş") }}
