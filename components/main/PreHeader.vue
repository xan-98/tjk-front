            ...
            <div class="dropdown-content">
              <span class="item">
                <a :href="'tel:' + $store.state.info.phone2">
                  <BIconTelephone></BIconTelephone>{{ $store.state.info.phone2 }}
                </a>
              </span>
              
              <span class="item">
                <a :href="'tel:' + $store.state.info.phone3">
                  <BIconTelephone></BIconTelephone>{{ $store.state.info.phone3 }}
                </a>
              </span>
            </div>
          </div>
        ...
        <div class="lang-picker">
          <div class="dropdown">
            <button class="dropbtn">
              <img
                :src="
                  '/_nuxt/assets/img/flags/' + $store.state.currentLang + '.png'
                "
                alt="TM"
              />
