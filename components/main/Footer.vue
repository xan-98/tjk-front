  ...
  <div>
    <footer>
      <div class="container">
        <div class="c-row">
          <div class="c-col">
            ...
            <div class="contacts">
              <a
                ...
                :href="'tel:' + $store.state.info.phone"
              >
            ...
            <div class="contacts">
              <a :href="'fax:' + $store.state.info.fax" class="hover:underline">
            ...
            <div class="contacts">
              <a :href="'mailto:' + 'gapturkmentjk@gmail.com'">
                <BIconEnvelope></BIconEnvelope>gapturkmentjk@gmail.com
              </a>
            </div>
          ...
          <div class="border-l border-gray-500 min-h-[80%] mb-5"></div>
            ...
            <ul>
              ...
              <li>
                <NuxtLink to="/help-order">{{
                  $tr.t("Saýtymyzdan nädip sargamaly")
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/help-payment">{{
                  $tr.t("Töleg tertibi we eltip bermek")
                }}</NuxtLink>
              </li>
            </ul>
          </div>

          <div class="border-l border-gray-500 min-h-1/2 mb-5"></div>
    ...
    <div class="copyright">
      <div class="container">
        ...
        <b>{{ $tr.t("Ähli hukuklar goragly.") }}</b>
      </div>
    </div>
  </div>
</template>
